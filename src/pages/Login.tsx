...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4 font-sans">
      <div className="w-full max-w-sm bg-white text-slate-800 rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="p-8 pt-4">
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="bg-blue-50 border border-blue-100 p-3 rounded-md text-xs text-blue-800 mb-4 text-center">
              Hint: You can use any testing credentials, e.g. <br/><strong className="select-all">admin@mrdu.edu.in</strong> / <strong>password123</strong>
            </div>
            ...
            <button
              type="submit"
              className="w-full mt-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm py-2.5 rounded-md transition-colors"
            >
              Sign In
            </button>
          </form>
